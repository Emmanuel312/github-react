...
import { Loading,Owner,Search,SearchWrapper,IssuesList,IssuesListLoading,PageFooter,PageButton } from './styles'
...
export default class Repository extends Component
{
    ...
    fetchIssues = async () =>
    {
        ...
        try
        {
            ...
            const { data } = await api.get(`repos/${repoName}/issues`, { params: { state:search, per_page: 5,page } })
    ...
    render()
    {
        const { loading, repository, issues,search,loadingIssues,page } = this.state
        console.log(page)   
        if(loading)
        ...
        return (
            <Container>
                ...
                <SearchWrapper>
                    <Search value={search} onKeyDown={this.handleSearch} onChange={this.handleChange} />
                </SearchWrapper>
